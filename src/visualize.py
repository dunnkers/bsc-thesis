...
def compare_classifiers_performance():
    ...
    plt.yticks(np.arange(0.5, 1.0, step=0.05))
...
compute_and_plot_confusion_matrix('./cache_140x280', clf='SVM')
compute_and_plot_confusion_matrix('./cache_140x280', clf='XGBoost')
